...
Common labels
*/}}
{{- define "keep-client.labels" -}}
helm.sh/chart: {{ include "keep-client.chart" . }}
{{ include "keep-client.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "keep-client.selectorLabels" -}}
...
*/}}
{{- define "keep-client.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "keep-client.fullname" .) .Values.serviceAccount.name }}
{{- else }}
